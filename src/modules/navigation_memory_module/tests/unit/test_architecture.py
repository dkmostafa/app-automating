...
from modules.navigation_memory_module.application import build_navigation_store
from modules.navigation_memory_module.domain import ports as ports_module
from modules.navigation_memory_module.domain.ports import (
    MemoryMaintenance,
    RouteMemory,
    RouteRecorder,
)
...
MODULE_PACKAGE = "modules.navigation_memory_module"
...
def test_the_composition_root_returns_something_that_satisfies_the_ports() -> None:
    ...
    from modules.navigation_memory_module.application.di import navigation_ports
...
OTHER_MODULE = "modules.appium_module"


def _appium_imports() -> dict[str, set[str]]:
    """Every ``modules.appium_module.*`` path this module imports, by file."""
...
def test_the_recording_adapter_satisfies_the_ports_it_claims() -> None:
    ...
    """
    from modules.appium_module.domain.ports import DeviceInteraction, SessionLifecycle
    from modules.navigation_memory_module.application.di import build_appium_port_decorator
