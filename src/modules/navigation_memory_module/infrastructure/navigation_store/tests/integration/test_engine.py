...
from modules.navigation_memory_module.infrastructure.navigation_store.config import (
    NavigationStoreConfig,
)
from modules.navigation_memory_module.infrastructure.navigation_store.engine import (
    NavigationDatabase,
)
...
async def test_a_missing_parent_directory_is_created(tmp_path: Path) -> None:
    """A fresh machine has no ~/.local/share/agentic-testing, and must not need one."""
