...
# One character over the line limit, and every way of getting under it is worse:
# importing the package instead would test the re-export rather than the source
# file this test is named after (Rule 2 §1).
from app_automating.modules.navigation_memory_module.infrastructure.navigation_store.parsing import (  # noqa: E501
    JOURNAL_MODES,
    SYNCHRONOUS_MODES,
...
@pytest.mark.parametrize(
    "path", ["/var/lib/nav.db", "nav.db", "~/.local/share/app-automating/navigation_memory.db"]
)
