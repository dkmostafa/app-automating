...
from app_automating.modules.appium_module.application.di import (
    appium_device_ports,
...
DI = "app_automating.modules.appium_module.application.di"
...
def test_the_real_service_can_be_built_without_touching_the_host() -> None:
    ...
    lets `server.py` build its object graph before anything is attached."""
