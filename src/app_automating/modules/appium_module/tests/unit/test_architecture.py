...
from app_automating.modules.appium_module.application import build_appium_device_manager
...
MODULE_PACKAGE = "app_automating.modules.appium_module"
...
def test_the_composition_root_returns_something_that_satisfies_the_ports() -> None:
    ...
    from app_automating.modules.appium_module.application.di import appium_device_ports
...
def test_the_composition_root_offers_a_generic_port_decorator_hook() -> None:
    ...
    """
    from app_automating.modules.appium_module.application.di import build_appium_device_service
